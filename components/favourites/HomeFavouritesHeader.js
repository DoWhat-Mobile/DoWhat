...
const HomeFavouritesHeader = ({ addingFavouritesToPlan, resetAddingFavourites,
    setAddFavouritesToPlan, viewAllEvents, numOfFavouriteEvents }) => {
    ...
    if (addingFavouritesToPlan) {
        return (
            <View style={styles.headerBar}>
                <View
                    style={styles.planWithFavouritesButton}
                >
                    <TouchableOpacity
        ...
        <View style={styles.headerBar}>
            <View style={styles.planWithFavouritesButton}>
                <TouchableOpacity
                    ...
                    style={[
                        styles.headerCategory, noFavouriteEventsYet
