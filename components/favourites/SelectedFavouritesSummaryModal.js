...
const SelectedFavouritesSummaryModal = ({
					...
					<View style={{ height: Dimensions.get('window').height * 0.07 }}>
						...
						>
							...
							<View style={{ flexDirection: 'row' }}>
								<Text style={{ fontSize: 12, color: '#1d3557', marginTop: 2 }}>
									{' '}
									{activity.location}
								</Text>
							</View>
	...
	if (!favouriteSummaryModalVisible) return null;

	return (
		<View style={styles.modalContainer}>
			<Badge
				value={<MaterialCommunityIcons name='chevron-down' color={'#cc5237'} size={28} />}
				badgeStyle={{
