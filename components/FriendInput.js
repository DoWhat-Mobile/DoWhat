			...
			<View style={styles.container}>
				...
				<View style={styles.body}>
					...
					<Text style={styles.subtitleText}>
						You have chosen your date and inputted your availabilities, now it's time to
						invite some of your friends to join you!
					</Text>
				</View>
		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.body}>
					<Image style={styles.image} source={require('../assets/FriendsHangout.png')} />
					<Text style={styles.subtitleText}>
						You have chosen your date and inputted your availabilities, now invite your
						friends to enter their availabilities as well!
					</Text>
					...
					<View style={styles.shareButtons}>
						<TouchableOpacity
							...
							onPress={() => shareWithTelegram(encodeUserInfoToURL(DoWhatWebURL))}
						>
							<MaterialCommunityIcons name='send-circle' color={'white'} size={20} />
						...
						<TouchableOpacity
							...
							onPress={() => shareWithWhatsapp(encodeUserInfoToURL(DoWhatWebURL))}
						>
							<MaterialCommunityIcons name='whatsapp' color={'white'} size={20} />
				...
				<View style={styles.footer}>
					...
					>
						<Text style={{ fontSize: 16, color: 'white' }}>Done Inviting</Text>
					</TouchableOpacity>
				</View>
			</View>
		);
