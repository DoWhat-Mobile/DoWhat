  ...
  const buttons = () =>
    genreType.map((items) => (
      <TouchableOpacity
        ...
        style={[
          styles.button,
          { backgroundColor: selected.includes(items) ? "#8c8c8c" : "#f2f2f2" },
        ]}
      >
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={{ fontSize: 20 }}>Choose your favourite genres!</Text>
      </View>
      ...
      <View style={{ flex: 1, justifyContent: "flex-end", marginBottom: 36 }}>
        <TouchableOpacity style={{ position: "absolute", marginLeft: 120 }}>
          <AntDesign
            name="arrowright"
            size={32}
            onPress={() => {
