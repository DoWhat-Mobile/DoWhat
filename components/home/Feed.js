...
const Feed = (props) => {
    ...
    const handleAddToFavourites = (event, sectionTitle, index, foodIndex) => {
        ...
        if (eventWithRating.favourited) {
            ...
            newState = newState.filter(
                (currEvent) => currEvent[0].id != event[0].id
            );
    ...
    const CategoryTitleText = ({ text, color }) => {
        return (
            <Text style={[styles.CategoryTitleText, { color: color }]}>
                {text}
            </Text>
        );
    };
                ...
                >
                    ...
                    >
                        <Feather
                            ...
                            size={18}
                            color={
                                currSelectedGenre == 0 ? "white" : COLORS.orange
                            }
                        />
                        <CategoryTitleText
                            text="POPULAR"
                    ...
                    >
                        <MaterialCommunityIcons
                            ...
                            size={18}
                            color={
                                currSelectedGenre == 1 ? "white" : COLORS.orange
                            }
                        />
                        <CategoryTitleText
                            text="EATERIES"
                    ...
                    >
                        <Feather
                            ...
                            size={18}
                            color={
                                currSelectedGenre == 2 ? "white" : COLORS.orange
                            }
                        />
                        <CategoryTitleText
                            text="DISCOVER"
