...
const ManualFavouritesModal = ({ usersFavourites, onClose }) => {
    ...
    console.log("User favourites", usersFavourites)
    return (
...
export default ManualFavouritesModal;
